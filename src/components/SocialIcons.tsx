  ...
  useEffect(() => {
    ...
    social.querySelectorAll("span").forEach((item) => {
      ...
      const onMouseMove = (e: MouseEvent) => {
        ...
        // If mouse is near the center, snap to it, else return to true center
        if (x < currentRect.width && x > 0 && y < currentRect.height && y > 0) {
          mouseX = x;
          mouseY = y;
        } else {
  ...
  return (
    <div className="icons-section">
      <div className="social-icons" data-cursor="icons" id="social">
        ...
        <span>
          <a
            href={portfolioData.contactLinks.promptbase}
            target="_blank"
            rel="noreferrer"
            aria-label="PromptBase"
          >
            <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
          </a>
        </span>
        <span>
          <a
            href={portfolioData.contactLinks.gumroad}
            target="_blank"
            rel="noreferrer"
            aria-label="Gumroad"
          >
      ...
      <a
        ...
        href={portfolioData.contactLinks.resume}
